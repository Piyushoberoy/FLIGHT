...
class Passenger(models.Model):
    ...
    # flight = models.ForeignKey(Flight, on_delete=models.CASCADE, related_name="passengers", default=1)
...
class PassengerFlight(models.Model):
    ...
    def __str__(self):
        return f"PassengerFlight - Passenger: {self.passenger}, Flight: {self.flight}"
